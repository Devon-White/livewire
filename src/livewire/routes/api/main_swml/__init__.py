...
from livewire.utils.api_utils import validate_json_request, api_error
...
@validate_json_request(
    required_fields=["call", "call.call_id", "call.project_id"],  # 'call' is required for setting call context
    field_types={
